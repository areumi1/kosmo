...
// 동일한 클래스는 import 해서 사용 불가능

import chapter08.EX01.A;
//import chapter08.EX01.com.A;		// 오류 발생 : 동일한 클래스는 import 할수 없다.

//import chapter08.EX01.B;		// 오류 발생 , 접근제어자가 (default) 
...
public class Using_Package02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("== com.A 클래스 접근 (public) ==");
		// 동일한 클래스는 import가 불가능 하므로 전체 이름을 사용해서 객체를 생성
