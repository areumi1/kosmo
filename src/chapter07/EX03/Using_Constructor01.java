...
class C{
	...
	C(int a){		// 입력 매개변수, 입력 매개변수를 받는 변수, 필드의 변수  3개의 이름이 동일할때 필드의 변수에  this를 사용해야함.
		m = a;
	}
...
public class Using_Constructor01 {
	...
	public static void main(String[] args) {
		// 객체 생성
		A a = new A();		// 기본생성자 호출 : A(), 생성자 생략된 경우 (컴파일러가 자동으로 넣어줌)
		...
		// 오류 발생
		//C c = new C();		// 오류 발생 : 생성자가 클래스 내부에 하나라도 존재하면 생성자를 자동으로 컴파일러 하지않음
