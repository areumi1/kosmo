...
class Student03 {
	...
	public void setGrade (int grade) {		// setter : grade 필듸의 값을 할당하는 setter
...
//		s3.serialNum = 2000;		// 접근 제어자 : private (외부 클래스에서 접근 할 수 없다. 직접 수정 불가능)
//		s3.studentID = 100;
//		s3.studentName = "홍길동";
