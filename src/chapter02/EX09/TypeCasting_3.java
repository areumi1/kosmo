...
public class TypeCasting_3 {
	...
	public static void main(String[] args) {
		...
		// # 1. 같은 자료형 간의 연산
		int value1 = 3 + 5;
		int value2 = 8/5;		// 1.6 ==> int (정수) ==> 1
								// 주의 : 나눗셈을 할경우 int타입으로 정의되면 정확한 값이 출력되지 않을수 있음
		double value2_1 = 8/5;	// 부정확한 값 출력 ( 1.0 ) 정수 나누기 정수 임으로 1.0 출력
		double value2_2 = 8.0/5;		// 정확한 값 출력 (1.6)
		
		float value3 = 3.0f + 5.0f;
		double value4 = 8.0 / 5.0;
		
		//byte, short 를 연산을 하면 정수 (int)로 처리해야됨.
		byte data1 = 3;
		byte data2 = 5;
		...
		// # 2. 다른 자료형 간의 연산 ( 작은 자료형이 큰자료형으로 자동으로 업캐스팅되어 연산됨)
