...
//상속을 사용한 다향적 표현
	...
	// - 다식 자식 클래스의 필드와 메소드를 사용 할려면 다운캐스팅을 해야 사용 가능
	// - 다운 캐스팅은 수동으로 적용됨.
...
public class Using_Polymorphism01 {
	...
	public static void main(String[] args) {
		...
		A a1 = new A();		// A 클래스는 A 타입이다. , A는 A이다.(X)
				// a2은 A, B 타입을 내포하고 있고, A 타입으로 지정
		A a2 = new B();		// B 클래스는 A 타입니다. , B는 A이다.(O)
				// a3은 A, B, C 타입을 내포하고 있고, A 타입으로 지정
		A a3 = new C();		// C 클래스는 A 타입이다. , C는 A이다.(O)
				// a4은 A, B, C, D 타입을 내포하고 있고, A 타입으로 지정
...
//		D d3 = new C();		// C는 D 이다. (O)
		D d4 = new D();		// D는 D 이다. (X)
