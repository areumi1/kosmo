...
public class Using_Polymorphism01_2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(a2.name);
			// a2 는 Person 타입으로 다운캐스팅 (Animal, Person 필드, 메소드 모두 접근)
		Person p1 = (Person)a2;
		...
		System.out.println(p2.personName);
			// 업캐스팅
		Animal a3 = p2;			// a3 는 Animal, Person을 내포하고 있고, Animal 타입으로 지정
		...
		// 4. Person_person 객체를 Animal 타입으로 생성
			// a4는 Animal, Person, Person_person 타입을 내포하고있고, Animal 타입으로 지정
		...
		// 5. Person_person 객체를 Person_person 타입으로 생성
			// pp2는 Animal, Person, Person_person 타입을 내포하고있고, Person_person 타입으로 지정
		...
		// 6. Person_person 객체를 Person 타입으로 생성
			//p10는 Animal, Person 타입을 내포하고있고, Person 타입으로 지정
