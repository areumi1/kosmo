...
public class Using_NonRectangle_Array {
	...
	public static void main(String[] args) {
		// 비정방형 배열 ": 각 행에서 대해서 열의 갯수가 다를때
		
		// 1. 방법1 : 비정방형 배열 선언후 방크기를 생성후 값 할당
		int [][] arr1 = new int [2][];		// 행의 갯수만 지정, 열의 갯수는 나중에 지정함
		arr1[0] = new int [2];		// 0번째 행에 열의 갯수 2개를 지정
		arr1[0][0]= 1;
		arr1[0][1]= 2;
		
		arr1[1] = new int [3];		// 1번째 행에 열의 갯수 3개를 지정
		arr1[1][0]= 3;
		arr1[1][1]= 4;
		arr1[1][2]= 5;
		...
		int [][] arr2 = new int[2][];		//비정방형 배열 선언 : 행의 갯수만 먼저선언, 열은 선언하지 않음
