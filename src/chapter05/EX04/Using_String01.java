...
public class Using_String01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1 == str11);			//str1 과 str11의 객체의 주소를 비교
				//false  <== 두객체의 번지수가 다르다.
		System.out.println(str1.equals(str11));		// str1 과 str11의 객체의 값을 비교
				//true	 <== 객체의 저장된 값을 비교
		...
		System.out.println(str2 == str22);			// str2 와 str22 는 동일한 번지를 가르킨다.
				//true
