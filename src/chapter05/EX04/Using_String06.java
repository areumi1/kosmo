...
public class Using_String06 {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.substring(0,5));	// index 0 ~ index 5 앞 까지 잘라라		//Java
		System.out.println(str1.substring(3,8));	// 3은 포함, 8 미포함 		//a Stu
		
		System.out.println(str1.substring(5));		// index 5 방부터 뒤로 모두 출력		//Study
