...
public class ArgumentOfMainMethod {
	...
	public static void main(String[] args) {
		...
		// main Method 의 입력 매개변수 전달하기 , 메소드(객체지향언어) = 함수
		//		- 메소드(함수)의 형식 : 리턴타입 메소드명 (입력매개변수){ 실행부 }
		//							void main (String[] args){ 실행부 }
		
		
		// main method의 입력 매개변수 args[i] 값을 받아서 각 변수에 할당.
		
		//안녕하세요 3 5.8 		<== String[] args
		
		
		String a = args[0];		// 안녕하세요	args[0]
		String b = args[1];		// 3		args[1]		//String배열
		String c = args[2];		// 5.8		argw[2]		//String배열
